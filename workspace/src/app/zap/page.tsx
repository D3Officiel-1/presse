        ...
        {videos.map((video, index) => {
          ...
          return (
            ...
            >
              ...
              {/* Action Side Rail corrigé sans blocage Framer Motion */}
              <div 
                className="absolute bottom-[130px] right-3 z-30 flex flex-col items-center gap-4 select-none touch-none"
              ...
              >
                <div className="flex flex-col items-center">
                  <button
                    ...
                    className={cn(
                      "flex h-11 w-11 items-center justify-center rounded-full border border-white/10 bg-black/30 text-white shadow-lg backdrop-blur-md active:scale-90 transition-transform duration-200",
                ...
                <div className="flex flex-col items-center">
                  <button
                    ...
                    className="flex h-11 w-11 items-center justify-center rounded-full border border-white/10 bg-black/30 text-white shadow-lg backdrop-blur-md active:scale-90 transition-transform duration-200"
                  >
                ...
                <div className="flex flex-col items-center pt-1">
                  <button
                    ...
                    className={cn(
                      "relative flex h-10 w-10 items-center justify-center rounded-full border-2 border-white/30 bg-neutral-900 shadow-xl overflow-hidden active:scale-90 transition-transform duration-200",
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <button
                        ...
                        className={cn(
                          "text-[9px] font-black px-1.5 py-0.5 rounded-full transition-all shrink-0 uppercase tracking-tighter active:scale-95 duration-100",

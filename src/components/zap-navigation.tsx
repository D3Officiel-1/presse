...
export function ZapNavigation() {
  ...
  return (
    <nav className={cn(
      "fixed bottom-6 left-1/2 -translate-x-1/2 w-[92%] max-w-[400px] h-16 rounded-[2.5rem] flex items-center justify-between px-2 z-50 transition-all duration-500",
      isFeedMode 
        ? "bg-black/40 backdrop-blur-2xl border border-white/10 shadow-[0_12px_40px_rgba(0,0,0,0.5)]" 

...
export default function AuthGatewayPage() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center p-4 bg-gradient-to-b from-[#F9F9FC] via-[#FFFFFF] to-[#EFEFF5] text-neutral-900 overflow-hidden relative">
      ...
      <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-12 gap-8 items-center relative z-10 px-2 sm:px-6">
        ...
        >
          ...
          <div className="flex flex-col items-center text-center md:hidden mb-12 relative pt-2">
            ...
            <motion.div 
              whileTap={{ scale: 0.95 }}
              className="w-24 h-24 p-3.5 bg-gradient-to-tr from-white via-neutral-50 to-white shadow-[0_20px_50px_rgba(124,58,237,0.15)] rounded-[2.5rem] border border-neutral-200 mb-4 flex items-center justify-center relative overflow-hidden backdrop-blur-xl"
            >
              <div className="absolute inset-0 bg-gradient-to-b from-white/40 to-transparent pointer-events-none" />
              <Logo className="w-full h-full" />
            </motion.div>
            
            <h1 className="text-5xl font-[1000] tracking-tight text-neutral-950 leading-none">
              ZAP<span className="text-primary italic font-serif">!</span>
            </h1>
            <p className="text-[10px] font-black uppercase tracking-[0.3em] text-primary mt-2.5 bg-primary/10 px-4 py-1.5 rounded-full border border-primary/20 backdrop-blur-sm">
          ...
          <Card className="border-neutral-200/80 shadow-[0_32px_64px_rgba(0,0,0,0.06)] backdrop-blur-2xl bg-white/70 rounded-[3rem] overflow-hidden relative group">
            ...
            <CardContent className="space-y-5 pt-4 pb-8 px-6 sm:px-8 relative z-10">
              ...
              <div className="relative flex py-2 items-center">
                ...
                <span className="flex-shrink mx-4 text-[10px] font-black uppercase tracking-[0.25em] text-neutral-400">ou rejoins l'aventure</span>
                <div className="flex-grow border-t border-neutral-200"></div>
              </div>

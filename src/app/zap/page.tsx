...
export default function FeedPage() {
  ...
  return (
    <div className="fixed inset-0 overflow-hidden bg-black text-white">
      ...
      <main ref={feedRef} className="h-full w-full snap-y snap-mandatory overflow-y-auto overscroll-none [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
        {videos.map((video) => {
            ...
            >
              <div className="absolute inset-0">
                <video
                  ...
                  onLoadedMetadata={(e) => {
                    setVideoDuration(prev => ({ ...prev, [video.id]: e.currentTarget.duration }));
                  }}
                  onTimeUpdate={(e) => {
                    setVideoProgress(prev => ({ ...prev, [video.id]: e.currentTarget.currentTime }));
                  }}
                />
